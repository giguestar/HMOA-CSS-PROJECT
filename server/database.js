...
function insertInitialData() {
  // 발주업체 초기 데이터
  const companies = [
    { name: 'LX', type: 'monthly_end', color: '#9333ea' },      // 보라색
    { name: '케스코', type: 'bimonthly', color: '#3b82f6' },    // 파란색
    { name: '청암', type: 'bimonthly_custom', color: '#10b981' }, // 초록색
    { name: '한샘', type: 'monthly_end', color: '#f59e0b' },    // 주황색
    { name: '홈CC', type: 'monthly_end', color: '#ef4444' },    // 빨간색
    { name: '해모아', type: 'monthly_end', color: '#06b6d4' }   // 청록색
  ];
